...
- Always verify you're on `main` before creating a new branch
...
- Use `gh pr create` command with proper title and description
...
2. **ALWAYS create a PR** - Even for small changes
