...
from adhd_planner.utils.validation import validate_time_range
...
class ScheduleSlot:
    ...
    def __init__(self, start: datetime, end: datetime, energy_level: str | None = None):
        self.start = start
        self.end = end
...
class CalendarService:
    ...
    def get_time_block(self, block_id: str) -> TimeBlock | None:
    ...
    def find_available_slots(
        ...
        work_end: str = "17:00",
        min_slot_duration: int | None = None,
        ...
        if current_time < work_end_dt:
            ...
            if gap_duration >= min_slot_duration:
                available_slots.append(ScheduleSlot(current_time, work_end_dt, energy_level))
